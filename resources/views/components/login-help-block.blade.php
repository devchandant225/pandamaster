        ...
        <div class="grid lg:grid-cols-2 gap-8 lg:gap-12 items-stretch">
                    ...
                    <div class="space-y-6">
                        ...
                        @else
                            ...
                            <div class="text-center">
                                <span class="text-gray-500 font-bold uppercase tracking-widest text-[10px]">New to Orion Star?</span>
                                <a href="{{ $adminSettings->register_url ?? '#' }}" class="text-yellow-500 hover:text-white font-black ml-3 uppercase tracking-tighter text-sm transition-colors border-b-2 border-yellow-500/30 hover:border-white">
                                    Join the VIPs
                                </a>
                            </div>
                        @endauth
            ...
            <div class="group relative bg-white/5 backdrop-blur-xl rounded-[3rem] p-8 md:p-12 border border-white/5 hover:border-purple-500/30 transition-all duration-700 hover:shadow-[0_40px_80px_-20px_rgba(168,85,247,0.15)] overflow-hidden">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-gray-400 text-lg mb-10 leading-relaxed font-medium">
                        Never play alone. Our dedicated Orion Star support team is standing by 24/7 to ensure your gaming experience remains legendary.
                    </p>
