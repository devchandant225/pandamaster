            ...
            @if($role === 'admin')
                ...
                <div class="py-2">
                    ...
                    <a href="{{ route('admin.game-categories.index') }}"
                       class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all {{ $active === 'game-categories' ? 'bg-[#D4AF37] text-black font-bold shadow-lg shadow-[#D4AF37]/20' : 'text-gray-400 hover:bg-gray-900 hover:text-white' }}">
                ...
                <div class="py-2">
                    ...
                    <a href="{{ route('admin.categories.index') }}"
                       class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all {{ $active === 'categories' ? 'bg-[#D4AF37] text-black font-bold shadow-lg shadow-[#D4AF37]/20' : 'text-gray-400 hover:bg-gray-900 hover:text-white' }}">
