        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div class="col-span-1 md:col-span-1">
                ...
                <div class="flex gap-4">
                    ...
                    @endif
                    @if(isset($adminSettings->telegram))
                        <a href="{{ $adminSettings->telegram }}" target="_blank" class="hover:text-yellow-500 transition-colors">
            ...
            <div>
                ...
                <ul class="space-y-4 text-sm font-bold">
                    ...
                    <li><a href="{{ $adminSettings->login_url ?? '#' }}" class="hover:text-yellow-500 transition-colors uppercase">Login</a></li>
                </ul>
            </div>
