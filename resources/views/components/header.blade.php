    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-20">
            ...
            <nav class="hidden md:flex items-center gap-6">
                ...
                <a href="{{ route('about') }}" class="relative group py-2 text-gray-300 hover:text-yellow-500 transition-colors font-bold text-xs tracking-wider uppercase">
                    About
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-yellow-500 transition-all duration-300 group-hover:w-full"></span>
                </a>
        ...
        >
            ...
            <a href="{{ route('about') }}" class="block text-lg font-bold text-gray-300 hover:text-yellow-500 uppercase italic">About</a>
