...
@section('title', 'Modify Classification - 888Realty Admin')
...
<div class="p-6 md:p-10 bg-gray-50 min-h-screen">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-10">
        <div>
            ...
            <h1 class="text-3xl md:text-4xl font-extrabold text-gray-900 tracking-tight">Edit <span class="text-[#D4AF37]">Category</span></h1>
            <p class="text-gray-500 mt-2 font-medium">Modifying: <span class="text-gray-900 font-bold">{{ $category->name }}</span></p>
        </div>
    </div>
