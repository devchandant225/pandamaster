...
@section('title', 'Edit Meta Tag - 888Realty')
...
<div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div>
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Edit Meta Tag</h1>
                <p class="text-gray-500 mt-1">Update SEO meta tags for {{ ucfirst(str_replace('-', ' ', $metaTag->page_type)) }}</p>
            </div>
                    ...
                    <div class="grid grid-cols-1 gap-8">
                        ...
                        <div class="group">
                            ...
                            <div class="flex items-center justify-between mt-2">
                                ...
                                <p class="text-sm text-gray-500 ml-auto">
                                    <span class="font-medium text-[#D4AF37]"><span id="title-count">{{ strlen($metaTag->title) }}</span></span> / 60 chars (recommended)
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="group">
                            ...
                            <textarea name="desc" id="desc" rows="4" maxlength="500" 
                                ...
                                placeholder="Enter meta description...">{{ old('desc', $metaTag->desc) }}</textarea>
                            <div class="flex items-center justify-between mt-2">
                                @error('desc')
                                    <p class="text-sm text-red-600 flex items-center gap-1">
                                        <i class="fas fa-exclamation-circle"></i>
                                ...
                                @enderror
                                <p class="text-sm text-gray-500 ml-auto">
                                    <span class="font-medium text-[#D4AF37]"><span id="desc-count">{{ strlen($metaTag->desc ?? '') }}</span></span> / 160 chars (recommended)
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="group">
                            ...
                            <textarea name="keyword" id="keyword" rows="3" maxlength="1000" 
                                ...
                                placeholder="keyword1, keyword2, keyword3">{{ old('keyword', $metaTag->keyword) }}</textarea>
                            @error('keyword')
                                <p class="mt-2 text-sm text-red-600 flex items-center gap-1">
                                    <i class="fas fa-exclamation-circle"></i>
                                    {{ $message }}
                        ...
                        <div class="group">
                            ...
                            @if($metaTag->image)
                                <div class="mb-4 p-3 bg-gray-50 rounded-xl border-2 border-gray-200 inline-block">
                                    <img src="{{ Storage::url($metaTag->image) }}" alt="Current meta image" class="w-40 h-20 object-cover rounded-lg border-2 border-gray-300">
                                    <p class="text-xs text-gray-500 text-center mt-2 font-medium">Current image</p>
                                </div>
                            @endif
                            <div class="relative">
                            ...
                            <p class="mt-2 text-sm text-gray-500 flex items-center gap-2">
                                <i class="fas fa-info-circle text-[#D4AF37]"></i>
                                <span>Recommended: 1200x630px, max 2MB (Leave empty to keep current image)</span>
                            </p>
                        </div>
                        ...
                        <div class="group pt-6 border-t-2 border-gray-200">
                            ...
                            <div class="flex items-center gap-4">
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $metaTag->is_active) ? 'checked' : '' }} class="sr-only peer">
