...
@section('title', 'Edit Article - Orion Star Admin')
                ...
                <div class="bg-white p-8 md:p-10 rounded-3xl border border-gray-100 shadow-sm">
                    <div class="space-y-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $post->title) }}" placeholder="e.g. 5 Pro Tips for Winning Big at Orion Star" 
