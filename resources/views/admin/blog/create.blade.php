                ...
                <div class="bg-white p-8 md:p-10 rounded-3xl border border-gray-100 shadow-sm">
                    <div class="space-y-6">
                        <div class="space-y-2">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title') }}" placeholder="e.g. 5 Tips for First-Time Home Buyers in Vancouver" 
                ...
                <div class="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
                    ...
                    <div class="space-y-5 text-left">
                        ...
                        <div class="space-y-1">
                            ...
                            <input type="text" name="meta_keywords" value="{{ old('meta_keywords') }}" placeholder="vancouver, real estate, matching" 
                                class="w-full h-10 px-4 bg-gray-50 border border-gray-100 focus:border-[#D4AF37] rounded-lg outline-none transition-all text-xs font-bold text-gray-900">
                        </div>
