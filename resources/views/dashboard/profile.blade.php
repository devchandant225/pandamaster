...
@section('title', 'My Profile - 888Realty')
        ...
        <div class="bg-black rounded-[2.5rem] p-8 md:p-12 mb-10 text-white relative overflow-hidden shadow-2xl shadow-black/20">
            ...
            <div class="relative z-10 flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-gray-400 font-medium text-lg italic mb-6">Real Estate Journey since {{ $user->created_at->format('Y') }}</p>
                    
                    <div class="flex flex-wrap justify-center md:justify-start gap-4">
                        <div class="px-5 py-2 bg-white/5 border border-white/5 rounded-2xl flex items-center gap-3">
                            <span class="text-xs font-bold text-gray-500 uppercase tracking-widest">Account Status</span>
                            <span class="text-lg font-black text-green-400">ACTIVE</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div x-show="activeTab === 'profile'" x-cloak class="p-8 md:p-12 animate-fade-in">
                        <div class="mb-10">
                            <h3 class="text-2xl font-black text-gray-900 tracking-tight">Personal Details</h3>
                            <p class="text-gray-500 text-sm mt-1">Manage your contact information.</p>
                        </div>
                        ...
                        <form action="{{ route('user.profile.update') }}" method="POST" class="space-y-8">
                            ...
                            <div class="grid md:grid-cols-2 gap-8">
                                ...
                                <div class="space-y-2">
                                    <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Phone Number</label>
                                ...
                                <div class="space-y-2">
                                    <label class="block text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Current City</label>
                    ...
                    <div x-show="activeTab === 'password'" x-cloak class="p-8 md:p-12 animate-fade-in">
                        ...
                        <form action="{{ route('user.profile.password') }}" method="POST" class="space-y-8">
                            @csrf
                            @method('PUT')
