...
class OrionStarSeeder extends Seeder
{
    ...
    protected function seedMetaTags(): void
    {
        ...
        $metaTags = [
            ...
            ['page_type' => 'fish-games', 'title' => 'Orion Stars Fish Games — Play Fish Shooting Games Online', 'desc' => 'Play Orion Stars fish games online. Experience skill-based shooting games with real rewards. Join competitive rooms and win genuine cash prizes.', 'keyword' => 'orion stars fish games, orion stars online fish games, play orion stars fish games, orion stars fish game, orion stars fish table', 'is_active' => true],
            ['page_type' => 'slot-games', 'title' => 'Orion Stars Slot Games — Spin and Win Real Money Online', 'desc' => 'Spin the reels on Orion Stars slot games. Classic three-reel machines and modern video slots with massive bonus features and jackpots.', 'keyword' => 'orion stars slot games, orion stars slots, play orion stars slots, orion stars slot machine games, orion stars casino slots', 'is_active' => true],
            ['page_type' => 'table-games', 'title' => 'Orion Stars Sweepstakes Table Games — Play Online', 'desc' => 'Strategic Orion Stars table games online. Play card games and sweepstakes games with real prize opportunities on any device.', 'keyword' => 'orion stars sweepstakes table games, orion stars table games, orion stars sweepstakes games, orion stars casino table games', 'is_active' => true],
            ['page_type' => 'keno', 'title' => 'Orion Stars Keno — Play Online Keno Games and Win Real Prizes', 'desc' => 'Play Orion Stars keno online. Pick your numbers, watch the draw, and win real prizes. Simple, fast, and exciting keno action.', 'keyword' => 'orion stars keno, orion stars keno games, play orion stars keno, orion stars online keno, orion stars keno login', 'is_active' => true],
        ];
